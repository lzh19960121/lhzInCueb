...
from AnswerApp.from_neo4j_extract_info.extract.stock_service import stock_trends_service, stock_company_service
...
def get_templates(properties):
    ...
    current_templates = get_template_by_title("买入", current_status)
